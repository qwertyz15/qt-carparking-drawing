...
class Canvas(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        try:
            with open('test123_org1', 'rb') as f:
                self.rect_list = pickle.load(f)
        except:
            self.rect_list = []
        self.undo_list = []
        self.redo_list = []
...
class RectangleInfoWidget(QtWidgets.QWidget):
    def __init__(self):
        ...
        try:
            with open('test123_org', 'rb') as f:
                self.rect_occu_list_widget = pickle.load(f)
        except:
            self.rect_occu_list_widget = []
        print(self.rect_occu_list_widget)
